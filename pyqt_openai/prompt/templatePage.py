...
#     def __initVal(self, db):
#         self.__db = db
#         self.__previousTemplateArr = self.__db.selectTemplatePromptUnit()
# 
#     def __initUi(self):
#         self.__addBtn = SvgButton()
#         self.__delBtn = SvgButton()
...
#         self.__db.updateTemplatePromptUnit(id, name, content)
# 
#     def __add(self):
#         dialog = InputDialog('Name', '', self)
#         reply = dialog.exec()
...
# 
#             id = self.__db.insertTemplatePromptUnit(text)
#             item1.setData(Qt.UserRole, id)
# 
#             self.__templateTable.itemChanged.connect(self.__saveUpdatedTemplate)
# 
...
#             self.__db.deleteTemplatePromptUnit(id)
