...
from pyqt_openai.image_widget.imageControlWidget import ImageControlWidget
...
from pyqt_openai.image_widget.imageHome import ImageHome
from pyqt_openai.image_widget.imageNavWidget import ImageNavWidget
...
class ImageMainWidget(QWidget):
    ...
    def __initVal(self):
        # ini
        self._show_history: bool | True = bool(CONFIG_MANAGER.get_image_property("show_history"))
        self._show_setting: bool | True = bool(CONFIG_MANAGER.get_image_property("show_setting"))
    ...
    def __initUi(self):
        ...
        self._rightSideBarWidget = ImageControlWidget()
