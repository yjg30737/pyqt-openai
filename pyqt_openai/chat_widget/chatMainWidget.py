...
from pyqt_openai.chat_widget.prompt_gen_widget.promptGeneratorWidget import (
    PromptGeneratorWidget,
)
from pyqt_openai.chat_widget.right_sidebar.chatRightSideBarWidget import (
    ChatRightSideBarWidget,
)
...
class ChatMainWidget(QWidget):
    ...
    def __initVal(self):
        ...
        self.__background_image = CONFIG_MANAGER.get_general_property(
            "background_image"
        )
        ...
        self.__maximum_messages_in_parameter = CONFIG_MANAGER.get_general_property(
            "maximum_messages_in_parameter"
        )

    def __initUi(self):
        self.__chatNavWidget = ChatNavWidget(
            ChatThreadContainer.get_keys(), THREAD_TABLE_NAME
        )
        ...
        self.__toggleFindToolButton = QPushButton(
