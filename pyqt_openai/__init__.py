...
SHORTCUT_JSON_MODE = 'Ctrl+J'
SHORTCUT_LEFT_SIDEBAR_WINDOW = 'Ctrl+L'
SHORTCUT_RIGHT_SIDEBAR_WINDOW = 'Ctrl+R'
SHORTCUT_CONTROL_PROMPT_WINDOW = 'Ctrl+Shift+C'
SHORTCUT_SETTING = 'Ctrl+Alt+S'
