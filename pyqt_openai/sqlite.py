...
class SqliteDatabase:
    ...
    def __initVal(self):
        ...
        self.__template_prompt_default_value_awesome_chatgpt_prompts = [
    ...
    def __createTemplatePromptGroup(self):
        ...
        if self.__c.fetchone()[0] == 1:
            ...
            self.insertTemplatePromptGroup('Awesome Chatgpt Prompts')
            self.insertTemplatePromptGroup('Alex Brogan')
    ...
    def insertTemplatePromptGroup(self, name):
        try:
            # Insert a row into the table
    ...
    def updateTemplatePromptGroup(self, id, name, text):
        try:
